    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-2xl">
            ...
            <div className="flex gap-4">
              <Link
                to="/products"
                className="px-8 py-3 bg-white text-green-600 rounded-md font-semibold hover:bg-green-50 transition flex items-center gap-2"
              >
                Shop Products <ArrowRight className="h-5 w-5" />
              </Link>
              <Link
                to="/energy-stats"
                className="px-8 py-3 bg-green-700 text-white rounded-md font-semibold hover:bg-green-800 transition"
              >
                View Energy Stats
              </Link>
            </div>
      ...
      <section className="py-20 bg-green-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to="/products"
            className="inline-flex items-center gap-2 px-8 py-3 bg-white text-green-600 rounded-md font-semibold hover:bg-green-50 transition"
          >
